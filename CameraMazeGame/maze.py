...
class Maze:
    ...
    def __init__(self, rows, cols, segmentLength, segmentWidth, xOffset, yOffset, screenWidth, screenHeight):
        ...
        self.maxVerticalTileRows
        self.maxVerticalTileCols
        self.maxHorizontalTileRows
        self.maxHorizontalTileCols
        self.startMaze()
    ...
    def getDrawWalls(self, screenLeft, screenTop, screenRight, screenBottom):
        pass
